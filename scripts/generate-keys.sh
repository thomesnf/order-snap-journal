...
echo "============================================" >&2
echo "Supabase Self-Hosted Key Generator" >&2
echo "============================================" >&2
echo "" >&2
...
if command -v node &> /dev/null; then
    ...
    echo "Installing jsonwebtoken package..." >&2
    ...
    echo "WARNING: Node.js not found. Using default JWT tokens." >&2
    echo "IMPORTANT: These are DEMO tokens. Generate real ones at:" >&2
    echo "https://supabase.com/docs/guides/self-hosting#api-keys" >&2
    echo "" >&2
