-- Update time_entries INSERT policy to allow assigned users
...
-- Update photos INSERT policy to allow assigned users
...
WITH CHECK (
  ...
  AND (
    ...
    OR
    -- Photo linked to a journal entry
    (
